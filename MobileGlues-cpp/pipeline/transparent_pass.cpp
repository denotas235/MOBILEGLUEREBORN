// MobileGlues - pipeline/transparent_pass.cpp
// Transparent pass - deferred to phase2_lighting and rendering_pipeline
...
namespace TransparentPass {
    bool init(int w,int h){ (void)w;(void)h; MG_LOG_I("TransparentPass: init"); return true; }
