// MobileGlues - pipeline/lighting_pass.cpp
// Lighting pass - deferred to phase2_lighting and rendering_pipeline
...
namespace LightingPass {
    bool init(int w,int h){ (void)w;(void)h; MG_LOG_I("LightingPass: init"); return true; }
